...
"[project]/app/api/debug/products/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data: products, error } = await supabase.from("products").select("id, name, seller_id, created_at").order("created_at", {
            ascending: false
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2f64521._.js.map