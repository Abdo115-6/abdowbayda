    ...
    const handleSignUp = async (e)=>{
        ...
        try {
            const { data, error: authError } = await supabase.auth.signUp({
                ...
                password,
                options: {
                    emailRedirectTo: process.env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/${role === "seller" ? "dashboard" : "marketplace"}`,
                    data: {
                        role: role
                    }
                }
...
//# sourceMappingURL=_02b48b29._.js.map