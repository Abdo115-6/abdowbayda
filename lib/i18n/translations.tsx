...
export const translations = {
  en: {
    ...
    "admin.tabs.buyers": "Buyers",
    "admin.tabs.winning": "Winning Products",
    "admin.tabs.products": "All Products",
    "admin.tabs.orders": "All Orders",
    "admin.winningProducts": "Top 10 Winning Products",
    "admin.winningProductsDesc": "Products with highest revenue and sales",
  ...
  ar: {
    ...
    "admin.tabs.sellers": "البائعون",
    "admin.tabs.buyers": "المشترون",
    "admin.tabs.winning": "المنتجات الرابحة",
    "admin.tabs.products": "جميع المنتجات",
    "admin.tabs.orders": "جميع الطلبات",
    "admin.winningProducts": "أفضل 10 منتجات رابحة",
    "admin.winningProductsDesc": "المنتجات ذات أعلى إيرادات ومبيعات",
    "admin.allProducts": "جميع المنتجات",
    "admin.searchProducts": "ابحث عن المنتجات...",
  ...
  fr: {
    ...
    "admin.tabs.buyers": "Acheteurs",
    "admin.tabs.winning": "Produits gagnants",
    "admin.tabs.products": "Tous les produits",
    "admin.tabs.orders": "Toutes les commandes",
    "admin.winningProducts": "Top 10 des produits gagnants",
    "admin.winningProductsDesc": "Produits avec le plus de revenus et de ventes",
    ...
    "checkout.productDetails": "Détails du produit",
    ...
    "orders.noOrders": "Aucune commande encore",
